...
def draw_bbox(img, box, cls_name, caption="", offset=(0,0)):
    '''
        draw box of an id
    '''
...
def draw_bboxes(img, bbox,identities=None, caption="", offset=(0,0)):
    for i,box in enumerate(bbox):
        ...
        cv2.rectangle(img,(0, 1),(0,1), color,-1)
        cv2.putText(img, caption, (x1, y1 - 10), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 255), 2)
